...
public class CefTest  extends JFrame {
    private static final long serialVersionUID = -5570653778104813836L;
    private static final Logger log = LogManager.getLogger(CefTest.class);
     ...
     */
    private CefTest(String startURL, boolean useOSR, boolean isTransparent, String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        ...
        client_ = CefUtil.createClient(cefApp_);
    ...
    public static void main(String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        ...
        new CefTest("http://www.baidu.com", useOsr, true, args);
    }
}